...
RSpec.describe NuecaRailsInterfaces::V2::Pagination do
  ...
  describe NuecaRailsInterfaces::V2::Pagination::KaminariAdapter do
  ...
  describe NuecaRailsInterfaces::V2::Pagination::PagyAdapter do
  ...
  describe 'Adapter Auto-Detection' do
    ...
    context 'when WillPaginate is defined' do
      ...
      it 'selects the WillPaginateAdapter' do
        expect(query_instance.send(:pagination_adapter)).to eq(NuecaRailsInterfaces::V2::Pagination::WillPaginateAdapter)
      end
    end
    ...
    context 'when Kaminari is defined' do
      ...
      it 'selects the KaminariAdapter' do
        expect(query_instance.send(:pagination_adapter)).to eq(NuecaRailsInterfaces::V2::Pagination::KaminariAdapter)
      end
    end
    ...
    context 'when Pagy is defined' do
      ...
      it 'selects the PagyAdapter' do
        expect(query_instance.send(:pagination_adapter)).to eq(NuecaRailsInterfaces::V2::Pagination::PagyAdapter)
      end
    end
